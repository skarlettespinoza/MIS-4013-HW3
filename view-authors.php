  ...
  <div class="col">
    <form method="GET" action="">
      <div class="input-group">
        <input type="text" class="form-control" name="search" placeholder="Search authors" value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
    ...
    <tbody>
      ...
      ?>
        <tr class="<?php echo $isHighlighted ? 'table-warning' : ''; ?>">
          ...
          <td><?php include "view-authors-editform.php"; ?></td>
          <td>
