  ...
  <?php while ($author = $authors->fetch_assoc()) { ?>
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">
          <ul class="list-group scrollable-reviews">
            <?php
              $genres = selectGenresByAuthor($author["author_id"]);
              while ($genre =  $genres->fetch_assoc()) {
            ?>
              <li class="list-group-item">
                <?php echo $genre["genre"];?> - <?php echo $genre["title"];?> - 
                <?php echo $genre["book_series"];?> - <?php echo $genre["publication_date"];?>
                - <?php echo $genre["review"];?>
              </li>
              <li class="list-group-item">
