      ...
      <div class="modal-body">
        <form method="post" action="">
          ...
          <div class="mb-3">
            ...
            <input type="date" class="form-control" id="aBirthdate<?php echo $author['author_id']; ?>" name="aBirthdate" value="<?php echo htmlspecialchars($author['author_birthdate']); ?>" onchange="calculateAge('<?php echo $author['author_id']; ?>')" required>
          </div>
          <div class="mb-3">
