    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
          <div class="mb-3">
            <label for="aName<?php echo $author['author_id']; ?>" class="form-label text-start">Author Name</label>
            <input type="text" class="form-control" id="aName<?php echo $author['author_id']; ?>" name="aName" value="<?php echo $author['author_name']; ?>">
          </div>
          <div class="mb-3">
            <label for="aBirthdate<?php echo $author['author_id']; ?>" class="form-label text-start">Author Birthdate</label>
